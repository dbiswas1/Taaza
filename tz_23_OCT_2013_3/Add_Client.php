...
if (isset($_POST["shop_name"]) && (strlen($_POST["shop_name"]) > 0) )
{
	if ($_POST["formid"] == $_SESSION["formid"])
	{
		$_SESSION["formid"] = '';
		if (strlen($_POST["dues"]) == 0) 
			$_POST["dues"]=0;
		$add_str="insert into client(dues,shop_name,client_name,ph_num, address ) values (".$_POST['dues'].",'".$_POST['shop_name']. "','" .$_POST['client_name']."','".$_POST['ph_no']."','".$_POST['ad_txt']."')" ;
		//echo $add_str;
		mysql_query($add_str);
...
<head>
<meta charset="utf-8">
<title>Taaza Tarkari- Add Client</title>
...
<div id="main">
  ...
  <div class="container">
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="span12">
        <form action="Add_Client.php?client=active&ad_client=active" method="post" name="clientform" onsubmit="return validate();">
          <div class="box paint color_24">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Add Client </span> </h4>
            </div>
             ...
             <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="shop_name">
                  </div>
                </div>
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="client_name">
                  </div>
                ...
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field" >Ph Number</label>
                  	<div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="ph_no">
                 	</div>
                 </div>
                ...
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field" >Dues</label>
                  	<div class="controls span4">
                    <input type="text" id="normal-field" value="0.00" class="row-fluid" name="dues" placeholder="0" onfocus="this.select();"  onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);">
                 	</div>
                 </div>
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <textarea rows="3" class="row-fluid" id="default-textarea" name="ad_txt"></textarea>
                  </div>
                </div>
       ...
       <p align="center"> <button type="submit"  class="btn btn-primary" name="save">Save Changes</button></p>
        </div>
        </form>
        <!-- End Box --> 
...
function validate()
{
	...
	y=document.forms["clientform"]["shop_name"].value;
	x=document.forms["clientform"]["client_name"].value
	if (x == "" || y == "" || x == null || y == null ) {
	
		alert ('Shop Name & client name are mandatory');
		return false;
	}
