...
<?php
	...
	$conn->selectdb();
	session_start();
	if (  isset($_POST['ex_txt']) || isset($_POST['emp_txt']) )
	{
	...
	$edit_query=mysql_query("select exp.exp_id,ex.ex_id,em.emp_id,ex.ex_type,em.emp_name,date_format(exp.exp_date,'%m-%d-%Y') as exp_date,exp.rec_no,exp.ex_amount from expense_type ex, employee em,expense exp where exp.exp_ex_id=ex.ex_id and em.emp_id=exp.exp_emp_id and exp.exp_id='$_GET[exid]'");
	$edit_arr=mysql_fetch_assoc($edit_query);
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="box color_5">
          ...
          <form  name="pay_form" action="View_Expense.php?expense=active&v_expense=active"  onsubmit="return validate();" method="post">
          		...
          		<fieldset>
                        <div class="form-row control-group row-fluid">
                          ...
                          <div class="controls span9">
                            <select name="ex_id" data-placeholder="Please select.." class="chzn-select" onchange="addoption(this.options[this.selectedIndex].value);">
                              <option value="<?php echo $edit_arr['ex_id']?>" selected><?php echo $edit_arr['ex_type']?></option>
                             <?php 
                             	$expense_array=mysql_query("select ex_id, ex_type from expense_type where ex_id != '$edit_arr[ex_id]' order by ex_type ");
                        ...
                        <div class="form-row control-group row-fluid">
                          ...
                          <div class="controls span9">
                            <select name="em_id" data-placeholder="Please select.." class="chzn-select" onchange="addoption1(this.options[this.selectedIndex].value);">
                              <option value="<?php echo $edit_arr['emp_id']; ?>" selected><?php echo $edit_arr['emp_name']; ?></option>
                             <?php 
                             	$employee_array=mysql_query("select emp_id, emp_name from employee where emp_id != '$edit_arr[emp_id]' order by emp_name ");
                        ...
                        <div class="form-row control-group row-fluid">
                          ...
                          <div class="controls span9">
                            ...
                            <input type="text" id="datepicker1"  name="date" value="<?php echo $edit_arr['exp_date']; ?>" 	class="row-fluid">
                            <input type="hidden" name="exp_id" value="<?php echo $edit_arr['exp_id']; ?>" />
                          </div>
                        </div>
                        ...
                        <div class="control-group row-fluid"> 
                          ...
                          <div class="controls span9">
                            <input type="text"  name="vouch" placeholder="0" class="row-fluid" value="<?php echo $edit_arr['rec_no']; ?>" onfocus="this.select();"  onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, true, false);">
                          </div>
                        </div>
                       ...
                       <div class="control-group row-fluid"> 
                          ...
                          <div class="controls span9">
                            <input type="text"  name="pay" placeholder="0"  value="<?php echo $edit_arr['ex_amount']; ?>" class="row-fluid" onfocus="this.select();"  onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);">
                          </div>
                        </div>
                   ...
                   <div class="description content">
                    <ul class="pager wizard mb5">
                      ...
                      <li class="next">
                        <button class="btn btn-primary btn-large pull-right" name="ex_edit_btn" type="submit" value="pressed">Submit Change <i class="icon-caret-right"></i></button>
                      </li>
...
<div class="avgrund-popup  stack modal" id="default-popup" >
 ...
 <form name="addtype" action="Edit_Expense.php?expense=active&v_expense=active&exid=<?php echo $_GET['exid'];?>" method="POST">
...
<div class="avgrund-popup  stack modal" id="default-popup1" >
 ...
 <form name="addemp" action="Edit_Expense.php?expense=active&v_expense=active&exid=<?php echo $_GET['exid'];?>"   method="POST">
  <div class="modal-body">
