...
<head>
<meta charset="utf-8">
<title>Taaza Tarkari - View Payments</title>
   ...
   <!--   <?php  //if(isset($_GET["dp_client"])){ ?> -->
      ...
      <div class="row-fluid">
        <div class="box color_24">
          <div class="title">
            <h4> <span>Payments Summary table <small>(Sorted in descending order)</small> </span> </h4>
          </div>
          <!-- End .title -->
                ...
                <tr>
                  ...
                  <td class="ms">
                  	<div class="btn-group" id="<?php echo $client_arr['p_id'] ;?>"> 
                  		<a class="btn btn-small" href="Edit_Payment.php?client=active&v_pay_client=active&shop_name=<?php echo $client_arr['shop_name'] ; ?>&cid=<?php echo $client_arr['c_id'] ;?>&pid=<?php echo $client_arr['pay_id'] ;?>" rel="tooltip" data-placement="top" data-original-title=" Edit " ><i class="gicon-edit"></i></a> 		
