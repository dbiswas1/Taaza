  ...
  <div class="container">
    ...
    <div id="main_container">
      <div class="row-fluid">
       ...
       <p align="center"> <button  type="button" onclick="location.href='print_pal_report.php?date=<?php echo $date ;?>';" name="in_btn" value="inden" class="btn btn-primary">Print</button>          <button  type="button" onclick="eraseCookie('verify');" name="log_btn" value="inden" class="btn btn-primary">Logout</button></p>
        </div>
