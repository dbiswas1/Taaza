...
<div id="main">
  <div class="container">
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="span12">
        <form action="view_indent.php?indent=active&in_indent=in&v_indent=active" onsubmit="return validate(cl_id.value);" method="post">
          <div class="box paint color_25">
            <div class="title">
              <h4> <i class="icon-book"></i><span>New Indent </span> </h4>
              <div class="span4">
              <select name="cl_id" data-placeholder="Choose a Client..." class="chzn-select">
              
                      <option   value=""></option>
                      <?php while ($cl_arr = mysql_fetch_array($client_array)) {?>
       ...
       <p align="center"> <button  type="submit" name="in_btn" value="inden" class="btn btn-primary">Add Indent</button> </p>
        </div>
