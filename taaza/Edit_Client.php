...
$result=mysql_query("select dues,shop_name,client_name,ph_num,address from client where c_id='$_GET[cid]'");
      ...
      <div class="row-fluid">
        ...
        <form action="Active_Client.php?client=active&ac_client=active" method="post">
          <div class="box paint color_24">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Edit Client </span> </h4>
            </div>
             ...
             <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field" >Ph Number</label>
                  	<div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="E_ph_no" value=<?php echo $client_details['ph_num'];?> >
                 	</div>
                 </div>
                 ...
                 <div class="form-row control-group row-fluid">
                  <label class="control-label span3" for="normal-field" > Dues </label>
                  	<div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="E_dues" value=<?php echo $client_details['dues'];?>  onfocus="this.select();"  onblur="extractNumber(this,2,false);" onkeyup="extractNumber(this,2,false);" onkeypress="return blockNonNumbers(this, event, true, false);">
                 	</div>
                 </div>
                 ...
                 <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span9">
                    <textarea rows="3" class="row-fluid" id="default-textarea" name="E_ad_txt" > <?php echo $client_details['address'];?> </textarea>
                  </div>
                </div>
		...
		<input type="hidden" name="cl_id" value="<?php echo $_GET["cid"]; ?>" />       
        <input type="hidden" name="formid" value="<?php echo $_SESSION["formid"]; ?>" />          
       <p align="center"> <button type="submit"  class="btn btn-primary" name="Editclient">Save Changes</button></p>
       <p align="center"> <button  href="Active_Client.php?client=active&ac_client=active" class="btn btn-primary" name="cancel">cancel</button></p>
        </div>
        </form>
        <!-- End Box --> 
