...
$purchase_query="select i.item,p.p_qty,p.p_price from item_master i , purchase_order p where p.pu_item_code=i.item_code and p.p_date = STR_TO_DATE( '".$_GET['date']."','%D-%b-%Y') and p.p_b_id=".$_GET['bid'];
$purchase_array=mysql_query($purchase_query);
...
<a href="#" name="9f7713ad245e8a357a6ce4d5f2ac972b27d7afab"></a><a href="#" name="0"></a>
	...
	<tr class="c12">
		...
		<td class="c2"><p class="c1 c24"><span class="c22"></span></p><h6 class="c1"><a name="h.4ms4pjdvvcn5"></a><span class="ct6">'.$m.'&nbsp;'.$d.', &nbsp;'.$y.'<br></span></h6><h6 class="c1"><a name="h.4ms4pjdvvcn5"></a></h6></td>
		<td class="c33 c34" align="right"><p class="c23 subtitle"><a name="h.f9dtygnsfopk"></a><span>PURCHASE DETAILS</span></p><h5 class="c23"><a name="h.rm9y3hcs0pf"></a><span class="c16">Purchased from </span><span>'.$_GET['name'].'</span></h5><h5 class="c23"><a name="h.pjxe0e68da60"></a></h5><p class="c8 c1 c24"><span></span></p></td>
	...
	<tbody>
		<tr class="c20">
			...
			<td class="c10 c39" align="right"><h2 class="c1 "><a name="h.rmx9glyl9qk1"></a><span class="c5 c7 c18 ct6">TOTAL PRICE</span></h2></td>
			<td class="c9" align="right"><h2 class="c1 ct5"><a name="h.rmx9glyl9qk1"></a><span class="c18 c5 c7 ct6">UNIT PRICE</span></h2></td>
			
			</tr> ';
			$sl_no=0;$total=0;$pg=1;
			while($purchase_arr=mysql_fetch_array($purchase_array)){
				
				$sl_no++;
				$invoice_txt.='<tr class="c20">
				
				<td class="c0" ><p class="c23"><span class="c5 ct6">  '.$purchase_arr[item].'  </span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span class="c5"></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span></span></p><p class="c6"><span class="c5"></span></p><p class="c6"><span class="c5"></span></p></td>
				<td class="c19" align="right"><p class="c1" ><span class="ct6">'.$purchase_arr[p_qty].'</span><span class="c5"></span></p></td>
				<td class="c39" align="right"><p class="c1" ><span class="c5 ct6">'.$purchase_arr[p_price].'</span></p></td>
				<td class="c9" align="right"><p class="c1" ><span class="c5 ct6">'.number_format(($purchase_arr[p_price]/$purchase_arr[p_qty]),2).'</span></p></td>
				</tr>
				';
				
				$total=($total)+($purchase_arr[p_price]) ;
				}$conn->close();
