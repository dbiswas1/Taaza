...
if (isset($_POST["market_name"]) && (strlen($_POST["market_name"]) > 0) )
{
	if ($_POST["formid"] == $_SESSION["formid"])
	{
		...
		$bill_str= "insert into biller(dues,market_name,biller_name,ph_num, address ) values (".$_POST['dues'].",'".$_POST['market_name']. "','" .$_POST['biller_name']. "','" .$_POST['ph_no']. "','".$_POST['ad_txt']."')";
		mysql_query($bill_str);
...
<head>
<meta charset="utf-8">
<title>Taaza Tarkari- Add Biller</title>
...
<div id="main">
  ...
  <div class="container">
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="span12">
        <form action="Add_Biller.php?purchase=active&ad_biller=active" method="post" name="billerform" onsubmit="return validate();">
          <div class="box paint color_13">
            <div class="title">
              <h4> <i class="icon-book"></i><span>Add Biller</span> </h4>
            </div>
             ...
             <div class="content">
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="market_name">
                  </div>
                </div>
                ...
                <div class="form-row control-group row-fluid">
                  ...
                  <div class="controls span4">
                    <input type="text" id="normal-field" class="row-fluid" name="biller_name">
                  </div>
...
function validate()
{
	...
	y=document.forms["billerform"]["market_name"].value;
	x=document.forms["billerform"]["biller_name"].value
	if ( y == "" ||  y == null ) {
	
		alert ('Market Name is mandatory');
		return false;
	}
