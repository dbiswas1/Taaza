...
<?php
	...
	$pay_arr_query=mysql_query("select p.bl_id,b.market_name,p.paid,date_format(p.date,'%m-%d-%Y') as pay_date,p.pay_b_no,p.dues from biller b , bill_payment_master p where p.bl_id='$_GET[bl_id]' and p.bill_b_id=b.b_id ");
...
<div id="main" style="min-height:1000px">
    ...
    <div id="main_container">
      <div class="row-fluid">
        <div class="box color_24">
          ...
          <form  name="pay_form" action="view_bill_payment.php?purchase=active&in_purchase=in&vp_purchase=active"  onsubmit="return validate();" method="post">
          		...
          		<fieldset>
                        <div class="form-row control-group row-fluid">
                          ...
                          <div class="controls span9">
                            <select name="b_id"  class="chzn-select">
                              <option value="<?php echo $_GET['bid']; ?>" selected><?php echo $_GET['market_name']; ?></option>
                             <?php 
                             	$client_array=mysql_query("select b_id, market_name from biller where b_id != '$_GET[bid]'");
                        ...
                        <div class="control-group row-fluid"> 
                          ...
                          <div class="controls span9">
                            <input type="text"  name="vouch" value="<?php echo $pay_arr['pay_b_no']; ?>" placeholder="<?php echo $pay_arr['pay_b_no']; ?>" class="row-fluid"  onfocus="this.value='';"  onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, true, false);">
                          </div>
                        </div>
  ...
  <?php $conn->close(); ?>
            ...
            <input type="hidden" name="bl_id" value="<?php echo $pay_arr['bl_id'] ;?>" />
            </form>
          </div>
          <!-- End .content --> 
        </div>
...
function validate()
{
	...
	x=document.forms["pay_form"]["b_id"].value
	if (x == "" || y == "" || x == null || y == null ) {
	
		alert ('Market Name and Amount are mandatory');
		return false;
	}
