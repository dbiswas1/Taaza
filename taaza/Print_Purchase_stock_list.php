...
<h6 class="c7 c35"><a name="h.4ms4pjdvvcn5"></a></h6></td><td class="c5"><h5 class="c22 c30"><a name="h.pjxe0e68da60"></a><span class="c8 c32"> PURCHASE ITEMS LIST</span></h5><p class="c3 c9"><span></span></p></td></tr></tbody></table>
...
for ($i=0 ; $i<$row_count ; $i++){ 
	...
	$Price_report_query=mysql_query("select s.s_item_code, s.s_id ,i.item, s.primary_stock  from inventory s, item_master i where s.s_item_code=i.item_code and s.primary_stock < 0  limit $limit,3" );
	...
	<td class="c18"><p class="c7"><span class="ct6">'. abs($price_arr[primary_stock]).'</span></p></td>';
		}
...
<p align ="right"><b>Total items to be purchased = ' .$sl_no1. ' Items</b></p>
