...
<h6 class="c7 c35"><a name="h.4ms4pjdvvcn5"></a></h6></td><td class="c5"><h5 class="c22 c30"><a name="h.pjxe0e68da60"></a><span class="c8 c32">'.$Price_Text.' PRICE LIST</span></h5><p class="c3 c9"><span></span></p></td></tr></tbody></table>
...
<tr class="c15">
	...
	<td class="c18 c25"><h2 class="c22 c30"><a name="h.rmx9glyl9qk1"></a><span class="c10 c8 c14 ct6">PRICE</span></h2></td>
	<td class="c20"><h2 class="c22 c31"><a name="h.rmx9glyl9qk1"></a><span class="c8 ct6">ITEMS</span></h2></td>
	<td class="c18 c25"><h2 class="c4"><a name="h.rmx9glyl9qk1"></a><span class="c8 ct6">PRICE</span></h2></td>
	<td class="c20"><h2 class="c22 c29"><a name="h.rmx9glyl9qk1"></a><span class="c8 ct6">ITEMS</span></h2></td>
	<td class="c0 c25"><h2 class="c4"><a name="h.rmx9glyl9qk1"></a><span class="c8 ct6">PRICE</span></h2></td>
</tr>';

for ($i=0 ; $i<$row_count ; $i++){ 
	
	
	$Price_report_query=mysql_query("select i.item, p.$Price_details from item_master i , price_list p where i.item_code=p.p_item_code and p.$Price_details > 0 limit $limit,3" );
	...
	<td class="c18"><p class="c7"><span class="ct6">'. $price_arr[$Price_details].'</span></p></td>';
		}
