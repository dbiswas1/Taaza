...
<a href="#" name="9f7713ad245e8a357a6ce4d5f2ac972b27d7afab"></a><a href="#" name="0"></a>
	...
	<tr class="c12">
		...
		<td class="c2"><p class="c1 c24"><span class="c22"></span></p><h6 class="c1"><a name="h.4ms4pjdvvcn5"></a><span>'.$m.'&nbsp;'.$d.', &nbsp;'.$y.'<br></span></h6><h6 class="c1"><a name="h.4ms4pjdvvcn5"></a><span>Invoice No. 00'.$_GET[invoice_no].'</span></h6></td>
	...
	<tbody>
		<tr class="c20">
			...
			while($invoice_report_arr=mysql_fetch_array($invoice_report)){
				...
				<td class="c19" align="right"><p class="c1" ><span>'.$invoice_report_arr[qty].'</span><span class="c5"></span></p></td>
				<td class="c39" align="right"><p class="c1" ><span class="c5">'.$invoice_report_arr[in_h_price].'</span></p></td>
				<td class="c9" align="right"><p class="c1" ><span class="c5">'.$invoice_report_arr[in_h_price]*$invoice_report_arr[qty].'</span></p></td>
				</tr>
				';
				...
				$invoice_txt.='<tr class="c20">
					...
					<td class="c38" align="right"><p class="c8 c6 c13"><span class="c5 c11"><b>'.number_format($total,2).'</b></span></p></td>
			...
			<tr class="c20">
				...
				<tr>
					<td class="c32" align="right"><p class="c8 c1"><span class="c7">LAST BILL ('.$last_bill_date.'):</span></p><p class="c8 c1"><span class="c7">LAST PAYMENT ('.$last_pay_date. '): </span></p><p class="c8 c1"><span class="c7">CREDIT  ('.$dues2_date.'):</span></p></td>
					
					
					<td class="c40" align="right"><p class="c8 c1"><span class="c7">'.number_format($last_bill,2).'</span></p><p class="c8 c1"><span class="c7">'.number_format($last_pay,2).'</span></p><p class="c8 c1"><span class="c7">'.number_format($dues2,2).'</span></p></td>
					
				</tr>
				
				<tr class="c20"><td class="c32" align="right"><p class="c8 c1"><span class="c7">GRAND TOTAL ('.$m.'-'.$d.'-'.$y. '):</span></p></td><td class="c40" align="right"><p class="c8 c1"><span class="c7">'.number_format($grand_total,2).'</span></p></td></tr>
