...
<?php
	...
	if (  isset($_POST["Editclient"])  || isset($_POST["cremove"])  )
	{
	...
	if ($_POST["formid"] == $_SESSION["formid"])
	{
		...
		if (  isset($_POST["Editclient"]))
			mysql_query("update client set shop_name='$_POST[E_shop_name]',client_name='$_POST[E_client_name]', ph_num='$_POST[E_ph_no]', address='$_POST[E_ad_txt]' where c_id='$_POST[cl_id]' ") ;
		if (  isset($_POST["cremove"]))
			mysql_query("delete from client where c_id='$_POST[cremove]'");
	}
	else
		exit ;
	}
        ...
        <div class="box color_24">
          ...
          <form id="del_form" action="Active_Client.php?client=active&ac_client=active" method="post">
            <table id="datatable_example" class="responsive table table-striped table-bordered" style="width:100%;margin-bottom:0; ">
              ...
              <tbody>
              <?php 
              	$result=mysql_query("select c_id,shop_name,client_name,ph_num,address,date_format(join_date, '%D-%b-%Y') as jdate from client where status=1");
                ...
                <tr>
                  ...
                  <td class="ms">
                  	<div class="btn-group" id="<?php echo $client_arr['c_id'] ;?>"> 
						...
						<a class="btn  btn-small" rel="tooltip" data-placement="top" data-original-title="Remove" onclick="javascript:openDialog();"><i class="gicon-remove"></i></a> 
